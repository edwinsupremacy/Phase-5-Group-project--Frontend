...
function Login({ setIsAuthenticated }) {
    ...
    const handleSubmit = async (event) => {
        ...
        if (isSignUp) {
            ...
            try {
                const response = await fetch('https://phase-5-group-project-backend-1.onrender.com/register', {
                    method: 'POST',
            ...
            try {
                const response = await fetch('https://phase-5-group-project-backend-1.onrender.com/login', {
                    method: 'POST',
                    headers: {
